...
const CoffeeReceipeScanner: React.FC<BrewScannerProps> = ({ onBack }) => {
            ...
            <View style={styles.phoneContainer}>
              <View style={styles.appHeader}>
                ...
                <View style={styles.headerContent}>
                  <View style={styles.headerRow}>
                    ...
                    <Text style={styles.headerTitle}>Sken kávovej etikety</Text>
                  </View>
              ...
              <View style={styles.mainContent}>
                <LinearGradient colors={WELCOME_GRADIENT} style={styles.welcomeCard}>
                  ...
                  <Text style={styles.welcomeText}>Skenovanie kávy</Text>
                  <Text style={styles.welcomeDesc}>
                    Odfoť etiketu alebo vyber fotku z galérie. Výsledok sa spracuje na pozadí.
                  </Text>
                </LinearGradient>
