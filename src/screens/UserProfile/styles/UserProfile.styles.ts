...
import { getSafeAreaTop, getSafeAreaBottom, scale, verticalScale } from '../../../components/utils/safeArea';
...
export const PRIMARY_GRADIENT = [palette.espresso, palette.medium];
